...
export const Markers = (props: { markers: MarkersProps[] }) => {
  ...
  const [dialog, setDialog] = useState<MarkersProps | false>(false);
  ...
  const prueba = (marker: MarkersProps) => {
    setDialog(marker);
  };
      ...
      {props.markers.map((marker: MarkersProps) => (
        ...
        >
          ...
          >
            ...
            <img src="/logo.png" alt="Logo Docensa" className="h-full" />

            {dialog && dialog.key === marker.key && (
